...
# In Holcim this group is not used. We are using groups generated by our IdP. Because of that, the next group is not required:
# ------- CDP Admin Group -------
# Create group
...
resource "cdp_environments_id_broker_mappings" "cdp_idbroker" {
  ...
  mappings = [{
    accessor_crn = "crn:altus:iam:eu-1:4917a224-566d-42f8-8f08-c14e81c22b36:group:admin/0cf32952-eaad-484c-9219-da2ac5de44ec" # Holcim admin group created by our IdP.
